  ...
  <div>
    <div class="top">
      <el-breadcrumb separator="/">
        ...
        >
        <el-breadcrumb-item :to="{ path: '/home/pinlei' }"
          >一级品类管理</el-breadcrumb-item
        >
        <el-breadcrumb-item>二级品类管理</el-breadcrumb-item>
      </el-breadcrumb>
      <h2>二级品类管理</h2>
    </div>
    <div class="bottom">
...
export default {
  ...
  methods: {
    ...
    get() {
      axios
        .get("/api/manage/category/get_category.do?categoryId=" + this.id)
        .then((res) => {
          console.log(res);
